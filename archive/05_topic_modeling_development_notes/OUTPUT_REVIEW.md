...
**File**: `data/intermediate/octis_reviews/optimization_results/sentence-transformers/paraphrase-mpnet-base-v2/results.csv`
...
2. **Delete the current result.json** to force a fresh start:
   ```bash
   rm data/intermediate/octis_reviews/optimization_results/sentence-transformers/paraphrase-mpnet-base-v2/result.json
   ```
...
python3 -c "
import json
with open('data/intermediate/octis_reviews/optimization_results/sentence-transformers/paraphrase-mpnet-base-v2/result.json') as f:
    d = json.load(f)
