...
try:
    ...
    from ..utils.data_loading import load_joined_reviews
except ImportError:
    # If running as script, use absolute import
    import sys
    from pathlib import Path
    # Go up from bertopic_preparation/ to 05_topic_modeling/
    sys.path.insert(0, str(Path(__file__).parent.parent.parent))
    from src.05_topic_modeling.utils.data_loading import load_joined_reviews
