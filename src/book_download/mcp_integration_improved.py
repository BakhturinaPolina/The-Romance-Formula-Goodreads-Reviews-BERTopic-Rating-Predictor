#!/usr/bin/env python3
"""
Book Download Research Component - Improved MCP Integration
Production-ready integration with format detection and validation
"""
...
class ImprovedAnnaMCPIntegration:
    """Improved integration with anna-mcp server with format detection"""
    
    def __init__(self):
        """Initialize improved MCP integration"""
        logger.info("Initializing Improved Anna MCP Integration")
        ...
        logger.info("Improved Anna MCP Integration initialized successfully")
...
def test_improved_mcp_integration():
    """Test the improved MCP integration functionality"""
    logger.info("=== TESTING IMPROVED MCP INTEGRATION ===")
    
    # Initialize integration
    mcp = ImprovedAnnaMCPIntegration()
    
    # Test format detection
    test_file = "/home/polina/Documents/goodreads_romance_research_cursor/romance-novel-nlp-research/organized_outputs/anna_archive_download/A Little Scandal.epub"
    if os.path.exists(test_file):
        actual_format = mcp._detect_file_format(test_file)
        logger.info(f"Detected format for {test_file}: {actual_format}")
    ...
    logger.info("Improved MCP integration test completed")

if __name__ == "__main__":
    test_improved_mcp_integration()
